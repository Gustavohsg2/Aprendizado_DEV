<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>EXERC - 16</title><!-- CONFIGS TAILWIND!!! -->
...
<main class="mx-auto my-36 w-96 h-auto text-center py-5 border bg-gray-900 px-5">
    <h1 class="text-6xl mb-3 text-white">PESO IDEAL</h1>
    <img src="img/logo.png" class="w-48 h-48 mx-auto" alt="UNIVAP">
    <form method="get" class="mt-5">
        <label for="altura" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Altura (em metros):</label>
        ...
        <label for="sexo" class="block mb-2 mt-3 text-sm font-medium text-gray-900 dark:text-white">Sexo:</label>
        ...
        <button type="submit" class="border text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mt-5">Calcular Peso Ideal</button>
        ...
        if ($_GET) {
            ...
            echo "<p class='text-white'>Seu peso ideal é: $peso_ideal kg</p>";
        }
        ?></div></main></body></html>